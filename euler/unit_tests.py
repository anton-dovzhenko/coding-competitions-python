...
from euler import utils, problem_1, problem_2, problem_3, problem_4, problem_5, problem_6, problem_7, problem_8, \
    ...
    problem_52, problem_54, problem_67, problem_56, problem_59, problem_51, problem_61
...
53503534226472524250874054075591789781264330331690'''), '5537376230')
    ...
    def test_problem59(self):
        self.assertEquals(problem_59.Solution.xor_decryption(), 129448)

    def test_problem61(self):
        self.assertEquals(problem_61.Solution.get_cyclical_figurate_numbers(), 28684)
    ...
    def test_problem67(self):
        ...
        self.assertEquals(problem_67.Solution.get_max_path_sum_ii_from_file('resources/p067_triangle.txt'), 7273)
